...
void render(const std::vector<Sphere> &spheres, unsigned width = 640, unsigned height = 480)
{
    ...
    constexpr const int numThreads = 12;
    constexpr const int grainSize = 2;
    //tbb:task_scheduler_init init(numThreads);     le terminal  ne reconnait pas la fonction task_...
    ...
    std::ofstream ofs("./untitled_tbb.ppm", std::ios::out | std::ios::binary);
    ofs << "P6\n" << width << " " << height << "\n255\n";
